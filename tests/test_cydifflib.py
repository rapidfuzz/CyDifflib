...
class TestWithAscii(unittest.TestCase):
    ...
    def test_bjunk(self):
        sm = cydifflib.SequenceMatcher(isjunk=lambda x: x == ' ',
        ...
        sm = cydifflib.SequenceMatcher(isjunk=lambda x: x in [' ', 'b'],
                a='a' * 40 + 'b' * 40, b='a' * 44 + 'b' * 40 + ' ' * 20)
...
class TestBytes(unittest.TestCase):
    ...
    def test_byte_filenames(self):
        ...
        actual = cydifflib.diff_bytes(unified, a, b, fna, fnb, datea, dateb,
                                    lineterm=b'')
        assertDiff(expect, actual)
    ...
    def test_mixed_types_filenames(self):
        ...
        self._assert_type_error(
            ...
            cydifflib.unified_diff, a, b, fna, fnb)
    ...
    def test_mixed_types_dates(self):
        ...
        self._assert_type_error(
            ...
            cydifflib.diff_bytes, cydifflib.unified_diff,
